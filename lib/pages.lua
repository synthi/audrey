-- pages.lua
-- v5.0.0 - Page navigation with grid sync
-- 2024-12-20
--
-- Changelog v5.0.0:
-- - Unified version numbering
-- - 9 pages organized by function
-- - Grid sync compatible
-- - Level 1 bars (dim, don't obscure text)

local Pages = {}

Pages.page_list = {
  {name = "SYNTHESIS", params = {"frequency", "feedback_gain", "feedback_body_delay", "brightness", "damping"}},
  {name = "DISTORTION", params = {"overdrive"}},
  {name = "FILTERS", params = {"lpf_cutoff", "lpf_q", "hpf_cutoff", "hpf_q"}},
  {name = "REVERB", params = {"reverb_mix", "reverb_decay", "reverb_lpf"}},
  {name = "TAPE DELAY", params = {"delay_time", "delay_feedback", "delay_send"}},
  {name = "TAPE CHARACTER", params = {"tape_wow_amount", "tape_flutter_amount", "tape_age", "tape_saturation"}},
  {name = "TAPE TONE", params = {"tape_lpf", "tape_hpf", "tape_hiss"}},
